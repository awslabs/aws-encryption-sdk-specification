...
- 0.6.0
  - REVERTED: Introduce configurable storage options
- 0.5.0
...
`kms-arn` MUST be the configured `AWS KMS Key ARN` in the [AWS KMS Configuration](#aws-kms-configuration) for this keystore.
