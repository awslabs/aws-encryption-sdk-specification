...
If [Storage](#storage) is configured with an [KeyStorageInterface](#KeyStorageInterface)
then this MUST be the configured [KeyStorageInterface interface](./key-store/key-storage-interface.md#interface).

If [Storage](#storage) is not configured with an [KeyStorageInterface](#KeyStorageInterface)
a [default encrypted key store](./key-store/default-key-storage-interface.md#initialization) MUST be created.

This constructed [default encrypted key store](./key-store/default-key-storage-interface.md#overview)
MUST be configured with the provided [logical keystore name](#logical-keystore-name).

This constructed [default encrypted key store](./key-store/default-key-storage-interface.md#initialization)
...
An [KeyStorageInterface interface](./key-store/key-storage-interface.md#interface)
...
from the configured [KeyStorageInterface interface](./key-store/key-storage-interface.md#interface)
by calling [GetKeyStorageInfo](./key-store/key-storage-interface.md#getkeystorageinfo).
...
then the key store MUST call the configured [KeyStorageInterface interface's](./key-store/key-storage-interface.md#interface)
[WriteNewEncryptedBranchKey](./key-store/key-storage-interface.md#writenewencryptedbranchkey) with these 3 [EncryptedHierarchicalKeys](./key-store/key-storage-interface.md#encryptedhierarchicalkey).
...
by calling the configured [KeyStorageInterface interface's](./key-store/key-storage-interface.md#interface)
[GetEncryptedActiveBranchKey](./key-store/key-storage-interface.md##getencryptedactivebranchkey)
using the `branch-key-id`.

The `KmsArn` of the [EncryptedHierarchicalKey](./key-store/key-storage-interface.md##encryptedhierarchicalkey)
...
The [EncryptedHierarchicalKey](./key-store/key-storage-interface.md##encryptedhierarchicalkey)
...
If creation of the keys are successful,
then the key store MUST call the configured [KeyStorageInterface interface's](./key-store/key-storage-interface.md#interface)
[WriteNewEncryptedBranchKeyVersion](./key-store/key-storage-interface.md##writenewencryptedbranchkeyversion)
with these 2 [EncryptedHierarchicalKeys](./key-store/key-storage-interface.md##encryptedhierarchicalkey).

If the [WriteNewEncryptedBranchKeyVersion](./key-store/key-storage-interface.md##writenewencryptedbranchkeyversion) is successful,
...
by calling the configured [KeyStorageInterface interface's](./key-store/key-storage-interface.md#interface)
[GetEncryptedActiveBranchKey](./key-store/key-storage-interface.md#getencryptedbranchkeyversion)
using the supplied `branch-key-id`.
...
by calling the configured [KeyStorageInterface interface's](./key-store/key-storage-interface.md#interface)
[GetEncryptedBeaconKey](./key-store/key-storage-interface.md#getencryptedbeaconkey)
using the supplied `branch-key-id`.
...
from an [encrypted hierarchical key](./key-store/key-storage-interface.md#encryptedhierarchicalkey).
...
of the [encrypted hierarchical key](./key-store/key-storage-interface.md#encryptedhierarchicalkey)
